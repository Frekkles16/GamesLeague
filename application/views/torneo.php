...
<header class="">
    ...
    <main>
        <section>
            <h1 class="font" style="margin-top: 50px;">El teus Tornejos</h1>
        </section>
            ...
            <form method="GET" action="<?php echo site_url('torneig/miPartida/' . $value['Id_Torneig'] ) ?>">
                <div class="row box mx-auto">
                    <div class="col-md-3 col-sm-3 fonts rt">
                        <h2 class="titulos_torneos">Nom torneig</h2>
                        <p class="nombre"><?php echo $value['Nom']?></p>
                    </div>
                    <div class="col-md-3 col-sm-3 fonts rt">
                        <h2 class="titulos_torneos">Data</h2>
                        <p class="nombre"><?php echo $value['Data']?></p>
                    </div>
                    <div class="col-md-3 col-sm-3 fonts rt">
                        <h2 class="titulos_torneos">Joc</h2>
