...
<header class="">
    ...
    <main>
        <section>
            ...
            <h1 class="nombre" style="text-align: center; margin-top: 50px;"><?php echo $value['Tipus']; ?></h1>
            <div class="container">
                <div class="row">
                    <div class="box r">
                        <div class="col-md-12">
                            
                            <h1 class="nombre" style="margin-top: 50px;"> <?php echo $value['Nom']; ?></h1>
                        ...
                        <div class="col-md-12 col-sm-12 col-12">
                            <h2 class="fonts input res text-center">Cuartos de final</h2>
                        </div>
