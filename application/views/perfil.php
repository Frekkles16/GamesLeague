...
<body>
    ...
    <main class="back">
        ...
        <section class="perfil col-md-10 col-sm-6">
            <div class="container p">
                <div class="box boxes perfil-padding">
                    <?php 
                    foreach($mios->result_array() as $valor) 
                    {
                      
                       echo '<p class="fonts text-center">Nom usuari</p><p class="foto-perfil-p text-center">' . $valor['Nom_Usuari'] . ' </p>';
                       echo "<br>";
                       
                       echo '<p class="fonts text-center">Nom</p><p class="foto-perfil-p text-center">' . $valor['Nom'] . ' </p>';
                    }
                     ?>
                </div>
            </div>
    ...
    <div class="perfil-body" style="margin-top: 50px;">
        <p class="fonts" style="text-align: center;">Seleciona el joc per veure les teves estadístiques </p>
    ...
    <form action="<?php echo site_url('torneig/afegirCompte') ?>" method="POST">
        <div class="perfil-body" style="margin-top: 50px;">
            <p class="fonts" style="text-align: center;">Seleciona el joc per afegir la teva compte </p>
            <div class="select mx-auto" style="width:150px;">
        ...
        <div class="tabla mx-auto row">
            <div class="col-md-6 col-sm-12 form_group mx-auto">
                <span class="text-center">
                    <i class="fas fa-gamepad fa-2x fa-align-center icon "></i>
                </span>
