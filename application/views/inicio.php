...
<body>
          ...
          <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav ml-auto " style="margin: 5px;">
              <li class="nav-item active">
                <a class="nav-link f-size-s" href="<?php echo site_url('torneig/login')?>">Inicia sessió</a>
              </li>
              <li class="nav-item">
                <a class="nav-link  f-size-s" href="<?php echo site_url('torneig/registro') ?>">Registrar-se</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container fondo">
        <div class="row">
            <div class="col-md-6 col-sm-12 Logo_texto_Naranja">
                <h1 class="f-size">GAMES LEAGUE</h1>
                <!--<img src="<?php echo base_url(); ?>img/Logo_texto_Naranja.png" alt="" class="imgrande">-->
            </div>
            <div class="col-md-6 col-sm-12 Logo_texto_Naranja">
                <img src="<?php echo base_url(); ?>img/lol.jpg" alt="" class="inicio">
            </div>
        </div>
    </div>
    <div class="iconos">´
        <h1 class="f-size-s text-center" style="margin-bottom: 75px;">Una web de tornejos que pensa en tu</h1>
        <div class="col-md-12 col-sm-12 Logo_texto_Naranja" style="margin-bottom: 50px;">
                <img src="<?php echo base_url(); ?>img/Logo_texto_Naranja.png" alt="" class="imgrande" style="margin: 0 auto; display:flex">
            </div>
        <div class="mid">
            <div class=" icn col-md-2 col-sm-12 col-12 centrar left">
                <span>
                    <i class="fas fa-chart-bar fa-7x fa-align-left"></i>
                </span>
            </div>
            <div class=" icn col-md-2 col-sm-12 col-12 centrar left">
                <p class="f-size-s m left">STATS</p>
            </div>
            <div class="icn col-md-2 col-sm-12 col-12 left">
                <span>
                    <i class="fas fa-gamepad fa-7x  fa-align-left"></i>
                </span>
            </div>
            <div class=" icn col-md-2 col-sm-12 centrar left">
                <p class="f-size-s m left">competitivitat</p>
            </div>
            <div class="icn col-md-2 col-sm-12 left">
                <span>
                    <i class="fas fa-user-times fa-7x fa-align-left"></i>
                </span>
            </div>
            <div class=" icn col-md-2 col-sm-12 centrar left">
    ...
    <div class="juegos" id="jocs">
        <div class="lol padre col-md-6 col-sm-12">
            ...
            <p class="fonts-s m">Llançar-se en mig del combat, donar suport als teus aliats... </p>
            <p class="fonts-s m">Prefereixis  el que prefereixis, trobaràs el teu lloc a l'Esquerda.</p>
        </div>
        </div>
        <div class="lol padre col-md-6 col-sm-12">
            <img src="<?php echo base_url();?>img/fifa.jpg" alt="" class="jugador " style="margin: 0 auto; display:flex">
            <div class="card-title text-center" style="color: white;"><p class="f-size-s">FIFA</p>
            <p class="fonts-s m">11 contra 11, seràs millor que el teu rival en el camp? </p>
            <p class="fonts-s m">Demostra-ho jugant a FIFA</p>
        </div>
        </div>
    </div>
            ...
            <div class="col-md-3 col-sm-12 ">
                ...
                <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        Quan accediu al servei mitjançant un dispositiu mòbil o mitjançant un dispositiu mòbil, és possible que recopilem certa informació de manera automàtica, incloent-hi, entre d'altres, el tipus de dispositiu mòbil que utilitzeu, l'identificador únic del vostre dispositiu mòbil, l'adreça IP del vostre dispositiu mòbil i el vostre mòbil. Sistema operatiu, el tipus de navegador d'Internet mòbil que utilitzeu, identificadors de dispositiu únics i altres dades de diagnòstic.
                        ...
                        Per proporcionar-vos notícies, ofertes especials i informació general sobre altres béns, serveis i esdeveniments que oferim, que són similars als que ja heu comprat o que heu consultat, tret que hàgiu optat per no rebre aquesta informació.

                        Per gestionar les vostres sol·licituds: per atendre i gestionar les vostres sol·licituds.

                        Per a transferències empresarials: podem utilitzar la vostra informació per avaluar o dur a terme una fusió, desinversió, reestructuració, reorganització, dissolució o altra venda o transferència d'alguns o de tots els nostres actius, sigui com a empresa en curs o com a part de fallida, liquidació, o un procediment similar, en el qual les dades personals que mantenim sobre els usuaris del nostre servei es troben entre els actius transferits.
                        ...
                        Us ho farem saber per correu electrònic o un avís destacat sobre el nostre servei, abans que el canvi entri en vigor i actualitzarem la data "Última actualització" a la part superior d'aquesta Política de privadesa.
